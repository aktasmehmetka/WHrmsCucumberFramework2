...
//    public static final String USERNAME="Admin";
    ...
    public static final String CREDENTIALS_FILEPATH=System.getProperty("user.dir")
    		+"\\src\\test\\resources\\comfigs\\configuration.properties";
    
    public static final String XL_DATA_FILEPATH=System.getProperty("user.dir")
    		+"\\src\\test\\resources\\testdata\\HrmsTestData.xlsx";
    
    public static final String FOR_PRACTICE=System.getProperty("User.dir")
    		+"\\src\\test\\java\\com\\practice\\Example.xlsx";
    ...
    public static final String USER_NAME_COMP=System.getProperty("user.name");
